export const guideContents = {
    ...
    steps: [
      {
        ...
        content: `
          <p>Shadow Hub utilise un système de rôles hiérarchique flexible qui s'adapte à tous types d'organisations eSport :</p>
      ...
      },
      {
        ...
        content: `
          <p>Pour les équipes avec des besoins spécifiques, Shadow Hub offre une granularité fine dans la gestion des permissions :</p>
  ...
  "gestion-remplacants": {
    ...
    steps: [
      ...
      {
        title: "Configuration dans Shadow Hub",
        content: `
    ...
    steps: [
      {
        ...
        content: `
          <p>Shadow Hub propose plusieurs types d'événements adaptés à tous vos besoins organisationnels :</p>
      ...
      },
      {
        ...
        content: `
          ...
          <ul>
            <li><strong>In-app :</strong> Notifications dans Shadow Hub</li>
  ...
  "systeme-feedback": {
    ...
    steps: [
      ...
      {
        title: "Outils de documentation dans Shadow Hub",
        content: `

...
const testimonials = [
  {
    ...
    game: "Valorant",
    content: "Core Link a révolutionné notre façon de préparer les matchs. Les outils d'analyse nous permettent d'identifier précisément les points d'amélioration de chaque joueur.",
    rating: 5
  },
  {
    name: "Sarah Chen",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Découvrez comment Core Link transforme déjà la gestion d'équipes eSport 
